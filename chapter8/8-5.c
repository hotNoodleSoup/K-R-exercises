// copy from https://github.com/anotherlin/tcpl/blob/master/chapter_8/exercise_8-5.c
// The book's original code doesn't work at now and I read tcpl's writing
// instead of finding out many function specifications.
